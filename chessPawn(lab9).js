...
//const ring2Geometry = new THREE.CylinderGeometry(1.8, 1.8, 0.6, 200);
//const ring2 = new THREE.Mesh(ring2Geometry, material);
//ring2.position.set(0, 2.3, 0);
...
const spikeGeometry = new THREE.CylinderGeometry(0.5, 0.5, 3.5, 100);
const spike = new THREE.Mesh(spikeGeometry, material);
spike.position.set(0,3.4,0);

let head = new THREE.Group();
head.add( ball);
head.position.set(0,2.7,0);

let chessQueen = new THREE.Group();
chessQueen.add(group, lathe1, head, ring, spike);
scene.add(chessQueen);
//chessQueen.add(group, lathe1, head, ring, spike);
//let chessQueen2 = new THREE.Group();
//chessQueen2.add(group, ring, ring2);
//scene.add(chessQueen);
